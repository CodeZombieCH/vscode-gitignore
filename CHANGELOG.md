...
- Raised minium API level to 1.63 to get access to authentication providers (see https://code.visualstudio.com/updates/v1_48#_using-authentication-providers)
- Refactored duplicate cleanup from providers into extension
- Upgraded to latest http proxy (should be replaced by high level `proxy-agent` package)
